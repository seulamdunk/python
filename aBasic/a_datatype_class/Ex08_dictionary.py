...
print(dt)
print(dt[1]) # 인덱스 아님 (1이라는 key)
print(dt['3'])

dt = {1:'one', 2:'two', '3':'three', 1:'first'}
print(dt[1]) # first > 동일한 키가 입력되면 덮어짐
...
# print(dt2[3]) > 존재하지 않는 키값으로 추출할때 에러발생
print(dt2.get(3)) # 에러 발생하지 않음 > none이라고 알려준다
print(dt2.get(3, '없음'))
